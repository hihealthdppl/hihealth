			...
			<div class="inner">
				...
				?>
					<form method="POST" action="update_user.php">
						...
						<div class="form-group">
							<input type="hidden" name="bb" value="<?php echo $d['nip']; ?>" class="form-control">
							<input type="hidden" name="tb" value="<?php echo $d['nik']; ?>"  class="form-control">
						</div>
						<div class="form-wrapper">
							<input type="hidden" name="ages" value="<?php echo $d['bagian']; ?>" class="form-control">
							<i class="zmdi zmdi-account"></i>
						</div>
						<div class="form-group">
