          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">Berita Kesehatan</h3>
                <p>Yuk ketahui Berita Kesehatan Terbaru Disini !</p>
                <p><a href="kesehatan/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/forum.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Forum</h3>
                <p>Yuk Berbincang Dengan Pengguna Lainnya Disini !</p>
                <p><a href="forum/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/podcast.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">PODCAST</h3>
                <p>Yuk Dengarkan Podcast Mengenai Kesehatan Disini !</p>
                <p><a href="podcast/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
        </div>
