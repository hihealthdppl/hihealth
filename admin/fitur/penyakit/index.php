    ...
    <div class="tm-container">
      ...
      <div class="tm-main-content"> 
        ...
        <section class="tm-section">
            <h2 class="tm-section-header">Penyakit</h2>
            ...
            <table>
              ...
              <tr>
                ...
                <td><?php echo $d['sebab']; ?></td>
				        ...
				        <td>
					          <a href="hapus_penyakit.php?id=<?php echo $d['id']; ?>">HAPUS</a>
                    <a href="edit_penyakit/index.php?id=<?php echo $d['id']; ?>">EDIT</a>
                </td>
              </tr>
              <?php
            }?>
      ...
      <footer>
        <p class="tm-text-white tm-footer-text" style="font-size: 40px; font-family:Noto Sans; font-style=normal; font-weight=bold">
          INGIN MENAMBAHKAN DATA PENYAKIT ? KLIK DISINI
          <p class="tm-text-white tm-footer-text" style="font-size: 40px; font-family:Noto Sans; font-style=normal; font-weight=bold"><a href="tambah_penyakit/index.php" class="tm-footer-link">Tambah Data Penyakit</a></p>
        </p>
      </footer>      
