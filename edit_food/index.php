    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                <div class="card-body">
                    <h2 class="title">Edit Data Makanan atau Minuman</h2>
                    <?php
                        include '../koneksi.php';
	                    $id = $_GET['id'];
                    ...
                    <form method="POST" action="update_food.php">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $d['kalori']; ?>" name="calory">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $d['satuan']; ?>" name="units">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $d['jenis']; ?>" name="jenis">
                        </div>
                        <div class="p-t-10">
                    ...
                    <form method="post" action="../daftar makanan/index.php">
                        <div class="p-t-10">
